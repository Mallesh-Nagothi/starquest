...
@Component
public class CredentialsSuccessBPMWorkItem implements ProcessBPMWorkItem {

private final String workItemName = SqEndPoints.VALIDATE_CREDENTIALS_SUCCESS_ENDPOINT.name();
	...
	public ResponseEntity<UserVo> callRestfulEndPoint(WorkItem workItem) throws Exception {
		...
		return restTeamplate.exchange(
				sqBpmConfig.getCredentialsSuccessFlowEndPointDetails().getUrl(),HttpMethod.POST, entity, UserVo.class);
	}
