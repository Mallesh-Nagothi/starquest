...
@Component
public class DecryptFailBPMWorkItem implements ProcessBPMWorkItem {

	private final String workItemName = SqEndPoints.PASSWORD_DECRYPT_FAIL_ENDPOINT.name();//change this to enum later
