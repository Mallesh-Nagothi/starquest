...
import com.poc.usermgmt.repositories.LoginRepository;
import com.poc.usermgmt.repositories.UserRepository;
...
public class UserBusinessLogicImpl implements UserBusinessLogic {
	...
	/* (non-Javadoc)
	 * @see com.poc.usermgmt.bizlogic.UserBusinessLogic#saveUser(com.poc.usermgmt.vo.UserVo)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.poc.usermgmt.service.UserBusinessLogic#findUserByLastName(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.poc.usermgmt.service.UserBusinessLogic#findUserById(java.lang.Integer)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.poc.usermgmt.service.UserBusinessLogic#findUserByEmail(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.poc.usermgmt.service.UserBusinessLogic#findAllUsers(int, int)
	 */
	@Override
